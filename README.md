# cordova-plugin-remote-injection-idbeny

## Latest(0.6.0)
[Latest Github](https://github.com/TruckMovers/cordova-plugin-remote-injection)（Forked From [TruckMovers-github](https://github.com/TruckMovers/cordova-plugin-remote-injection)）

---

## Installation
```bash
cordova plugin add cordova-plugin-remote-injection-idbeny
```
